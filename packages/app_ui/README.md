...
**❗ In order to start using App Ui you must have the [Flutter SDK][flutter_install_link] installed
on your machine.**
...
App Ui comes with a built-in [GitHub Actions workflow][github_actions_link] powered
