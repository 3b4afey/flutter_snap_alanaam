...
When you try to add a package (like image_picker) to pick an image from a gallery/camera, you will
face a lot of issues like:-
...
- If your app has a beautiful design and a good user experience, image_picker will break all of
  this, Because image_picker has a traditional UI of Gallery display.
...
The [device_info_plus](https://pub.dev/packages/device_info_plus) plugin, for example, can be used
...
<key>NSPhotoLibraryUsageDescription</key><string>your usage description here</string><key>
NSCameraUsageDescription
</key><string>your usage description here</string><key>NSMicrophoneUsageDescription</key><string>
