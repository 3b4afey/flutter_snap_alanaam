...
**❗ In order to start using Env you must have the [Flutter SDK][flutter_install_link] installed on
your machine.**
...
Env comes with a built-in [GitHub Actions workflow][github_actions_link] powered
