...
**❗ In order to start using Api Repository you must have the [Dart SDK][dart_install_link] installed
on your machine.**

Install via `dart pub add`:

```sh
dart pub add api_repository
```
...
Api Repository comes with a built-in [GitHub Actions workflow][github_actions_link] powered
