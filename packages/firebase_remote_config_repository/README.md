# Firebase Remote Config Repository
...
**❗ In order to start using Firebase Remote Config Repository you must have
the [Flutter SDK][flutter_install_link] installed on your machine.**

Install via `flutter pub add`:

```sh
dart pub add firebase_remote_config_repository
```
...
Firebase Remote Config Repository comes with a
built-in [GitHub Actions workflow][github_actions_link] powered
