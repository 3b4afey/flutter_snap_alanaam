...
import 'package:snap_alanaam_blocks_ui/src/attachments/widgets/widgets.dart';
...
class UrlAttachment extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      margin: EdgeInsets.only(bottom: l),
...
class UrlAttachmentImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final screenWidth = (context.screenWidth * .85) - (md * 5) - l;
