...
**❗ In order to start using Snap Alanaam Blocks Ui you must have
the [Flutter SDK][flutter_install_link] installed on your machine.**

Install via `flutter pub add`:

```sh
dart pub add snap_alanaam_blocks_ui
```
...
Snap Alanaam Blocks Ui comes with a built-in [GitHub Actions workflow][github_actions_link] powered
