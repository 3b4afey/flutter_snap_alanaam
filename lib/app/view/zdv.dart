...
// // import 'package:flutter_snap_alanaam/features/authentication/presentation/view/auth_view.dart';
...
// // import 'package:flutter_snap_alanaam/features/user_profile/view/widgets/user_profile_statistics.dart';
// // import 'package:go_router/go_router.dart';
// // import 'package:posts_repository/posts_repository.dart';
// // import 'package:user_repository/user_repository.dart';
// //
// // final _routNavigatorKey = GlobalKey<NavigatorState>(debugLabel: 'root');
// //
// // GoRouter router(AppBloc appBloc) {
// //   return GoRouter(
// //     navigatorKey: _routNavigatorKey,
...
// //         parentNavigatorKey: _routNavigatorKey,
// //         pageBuilder: (context, state) {
// //           final userIds = state.pathParameters['user_id']!;
// //
// //           return CustomTransitionPage(
// //             key: state.pageKey,
// //             child: UserProfileView(userId: userIds),
// //             transitionsBuilder:
...
// //         parentNavigatorKey: _routNavigatorKey,
// //         builder: (context, state, navigathionShell) {
// //           return HomePage(navigationShell: navigathionShell);
// //         },
// //         branches: [
...
// //                 child: AppScaffold(body: Text('Feed Page')),
// //                 transitionsBuilder:
// //                     (context, animation, secondaryAnimation, child) {
...
// //               path: '/chats',
// //               pageBuilder: (context, state) => CustomTransitionPage(
// //                 child: AppScaffold(body: Text('Chat Page')),
// //                 transitionsBuilder:
// //                     (context, animation, secondaryAnimation, child) {
// //                   return SharedAxisTransition(
// //                     animation: animation,
...
//             //   props: props ?? const UserProfileProps.build(),
//             // ),
//             child: AppScaffold(body: Center(child: Text(' UserProfile Props '),)),
//             transitionsBuilder:
//                 (context, animation, secondaryAnimation, child) {
//               return SharedAxisTransition(
//                 animation: animation,
...
//                     child: AppScaffold(body: Center(child: Text(' feed Props '),)),
//
//                     transitionsBuilder:
//                         (context, animation, secondaryAnimation, child) {
//                       return SharedAxisTransition(
...
//                     child: AppScaffold(body: Center(child: Text(' reels Props '),)),
//
//                     transitionsBuilder:
//                         (context, animation, secondaryAnimation, child) {
//                       return FadeTransition(
...
//                   return CustomTransitionPage(
//                     key: state.pageKey,
//                     child: UserProfileView(userId: user.id),
//                     transitionsBuilder:
//                         (context, animation, secondaryAnimation, child) {
//                       return SharedAxisTransition(
//                         animation: animation,
