...
import 'package:flutter_snap_alanaam/features/chats/chat/widgets/widgets.dart';
...
class MessageSharedPostImage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final screenWidth = (context.screenWidth * .85) - md * 2;
