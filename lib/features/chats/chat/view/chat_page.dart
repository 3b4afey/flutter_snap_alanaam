...
import 'package:flutter_snap_alanaam/features/chats/chat/chat.dart';
import 'package:flutter_snap_alanaam/l10n/l10n.dart';
// import 'package:flutter_snap_alanaam/stories/stories.dart';
  ...
  Widget build(BuildContext context) {
    return Positioned.fill(
      child: switch (context.isLight) {
        true =>
          Assets.images.photos.chatBackgroundLightOverlay.image(fit: BoxFit.cover),
        false => ShaderMask(
            ...
            child:
                Assets.images.photos.chatBackgroundDarkMask.image(fit: BoxFit.cover),
          ),
      },
    );
  }
  ...
  Widget build(BuildContext context) {
    return AppBar(
      ...
      title: ListTile(
        ...
        subtitle: Text(participant.displayUsername),
