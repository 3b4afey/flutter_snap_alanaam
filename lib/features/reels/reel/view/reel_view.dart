...
import 'package:flutter_snap_alanaam/features/reels/reel/reel.dart';
            ...
            VerticalGroup(
              ...
              onButtonTap: !isOwner
                  ...
                  : () => context.showListOptionsModal(
                        options: [
                          ModalOption(
                            name: context.l10n.loginText,
                            actionTitle: context.l10n.loginText,
                            actionContent: context.l10n.loginText,
                            actionYesText: context.l10n.loginText,
                            actionNoText: context.l10n.loginText,
            ...
            child: Tappable(
              ...
              child: DecoratedBox(
                ...
                child: Padding(
                  ...
                  child: Align(
                    child: Text(
                      isFollowed ?? false ? l10n.loginText : l10n.loginText,
                      style: context.bodyLarge?.copyWith(
                        color: AppColors.white,
                        fontWeight: FontWeight.bold,
                      ),
              ...
              child: Row(
                children: [
                  ...
                  Flexible(
                    flex: 6,
                    child: RunningText(
                      text: '$participant • ${context.l10n.loginText}',
                      velocity: 40,
