...
class SignUpEmailFormField extends StatefulWidget {
  const SignUpEmailFormField({super.key});

  @override
  State<SignUpEmailFormField> createState() => _SignUpEmailFormField();
}

class _SignUpEmailFormField extends State<SignUpEmailFormField> {
