...
class SignUpPasswordFormField extends StatefulWidget {
  const SignUpPasswordFormField({super.key});

  @override
  State<SignUpPasswordFormField> createState() => _SignUpPasswordFormField();
}

class _SignUpPasswordFormField extends State<SignUpPasswordFormField> {
