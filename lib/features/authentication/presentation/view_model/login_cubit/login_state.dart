...
enum LogInSubmissionStatus {
  ...
  /// [LogInSubmissionStatus.FacebookAuthInProgress] indicates that user has
  /// submitted login with facebook.
  facebookAuthInProgress,
  ...
  bool get isFaceBookAuthInProgress =>
      this == LogInSubmissionStatus.facebookAuthInProgress;
