...
class UserActionButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final textStyle = context.bodyLarge?.copyWith(fontWeight: FontWeight.w600);
    ...
    late final Widget followingButton = BetterStreamBuilder(
      ...
      builder: (context, isFollowed) {
        return UserProfileButton(
          onTap: onTap,
          label: isFollowed ? l10n.loginText : l10n.loginText,
          padding: padding,
          textStyle: textStyle,
          fadeStrength: fadeStrength,
          color: isFollowed
            ...
            return Text.rich(
              TextSpan(
                children: [
                  ...
                  TextSpan(
                    text: followed ? l10n.loginText : l10n.loginText,
